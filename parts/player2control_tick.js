...
Game.print("Player 2 health: "+Math.ceil(health/250)+"%", 20, 80, true, [0.0, 0.6, 1.0, 1.0]);
Game.print("Player 2 heat: "+heat, 20, 100, true, (heat>=10000)?([0.7, 0.0, 0.0, 1.0]):([0.0, 0.6, 1.0, 1.0]));
Game.print("Player 2 fuel: "+Math.round(fuel), 20, 120, true, [0.0, 0.6, 1.0, 1.0]);